...
def test_successful_connection(mock_env_vars, mock_psycopg_connect, mock_connection, caplog):
    ...
    mock_psycopg_connect.assert_called_with(conn_string, row_factory=mock_connection.row_factory)
...
def test_connection_with_invalid_credentials(mock_env_vars, mock_psycopg_connect, caplog):
...
def test_disconnect_active_connection(mock_env_vars, mock_psycopg_connect, mock_connection, caplog):
...
def test_auto_reconnection(mock_env_vars, mock_psycopg_connect, mock_connection, caplog):
