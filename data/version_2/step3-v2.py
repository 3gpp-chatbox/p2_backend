...
def process_procedure(section_name):
    ...
    step1_data = read_json_file("data/version_2/v02-step1.json")
    step2_data = read_json_file("data/version_2/v02-step2.json")

    if step1_data is None or step2_data is None:
        print("Failed to load v02-step1.json or v02-step2.json")
        return None
...
if procedural_info:
    save_to_json(procedural_info, "data/version_2/v02-step3.json")
else:
