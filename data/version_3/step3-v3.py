...
def process_procedure(section_name):
    ...
    step1_data = read_json_file("data/version_3/step1-v3.json")
    step2_data = read_json_file("data/version_3/step2-v3.json")
...
if procedural_info:
    save_to_json(procedural_info, "data/version_3/step3-v3.json")
else:
